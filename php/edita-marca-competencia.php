...
$baja=FALSE;
?>
<form id="edita-marca" name="edita-frm" action="php/actualiza-marca-competencia.php" method="post" enctype="multipart/form-data">
	<fieldset>
		<legend>Edita Marcas de Competencia: <?php echo $competencia; ?></legend>

		<?php include("formulario-marcas.php"); ?>
		<div>
			<br>
			<input type="submit" id="enviar-edit" title="Actualiza esta Marca de la Competencia" class="cambio" name="actualizar_sbm" value="Actualiza Marca" />
			&nbsp;
