<?php 
 ...
 ?>
		...
		<div>
			<?php 
			if ($imagen) 
	    			echo "<img src='img/fotos/$imagen' class='textwrap' width='5%' height='60'/>";
	 		?>
			...
			<span  class="rotulo">Nació: <?php $fn=substr($nacimiento, 0,4); $ed=edad_deportiva($nacimiento); echo "$fn&nbsp;&nbsp; Edad: $ed&nbsp&nbsp;Sexo: $sexo" ; ?> 
			</span>
	...
	<fieldset width="100%">
		...
		<table width='100%' border='1' bordercolor='#0000FF' cellspacing='0.5em' cellpadding='0.5em' class="tablas">
			...
			<caption><b>Saltos a Ejecutar (si los 2 clavadistas ejecutan el mismo salto solo diligencie clavadista 1)<b></caption>
			<thead align="center">
				<tr>
					<th width="1%"></th>
					<th width="2%" colspan="3">Clavadista No. 1</th>
					<th width="2%" colspan="3">Clavadista No. 2</th>
			...
			<tbody>
				<?php 
					for ($i=1; $i <=11 ; $i++) { 
						...
						$name="co2"."$i"."_txt";
						echo "<td width='2%' align='left'>
									<input type='text' name='$name' size='5' value='$co2'"; 
						if ($ok) echo " readonly";
						$name="co2"."$i"."_sbm";
						echo "></td>";
						...
						echo "<td width='1%' align='center'>
										<select name='$name' align='center' >
											<option ></option> 
											<option ";
						if ($po2=="A") echo " selected";
						echo ">A</option> 
											<option ";
						if ($po2=="B") echo " selected"; 
						echo ">B</option> 
											<option "; 
						if ($po2=="C") echo " selected"; 
						echo ">C</option> 
											<option ";
						if ($po2=="D") echo " selected";
						echo ">D</option> 
										</select>
									</td>";

						echo "<td width='30%' >$sa2</td>";
