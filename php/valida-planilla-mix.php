...
$co21=(isset($_POST["co21_txt"])?trim($_POST["co21_txt"]):null);
$po21=(isset($_POST["po21_slc"])?trim($_POST["po21_slc"]):null);
...
$co22=(isset($_POST["co22_txt"])?trim($_POST["co22_txt"]):null);
$po22=(isset($_POST["po22_slc"])?trim($_POST["po22_slc"]):null);
...
$co23=(isset($_POST["co23_txt"])?trim($_POST["co23_txt"]):null);
$po23=(isset($_POST["po23_slc"])?trim($_POST["po23_slc"]):null);
...
$co24=(isset($_POST["co24_txt"])?trim($_POST["co24_txt"]):null);
$po24=(isset($_POST["po24_slc"])?trim($_POST["po24_slc"]):null);
...
$co25=(isset($_POST["co25_txt"])?trim($_POST["co25_txt"]):null);
$po25=(isset($_POST["po25_slc"])?trim($_POST["po25_slc"]):null);
...
$co26=(isset($_POST["co26_txt"])?trim($_POST["co26_txt"]):null);
$po26=(isset($_POST["po26_slc"])?trim($_POST["po26_slc"]):null);
...
$co27=(isset($_POST["co27_txt"])?trim($_POST["co27_txt"]):null);
$po27=(isset($_POST["po27_slc"])?trim($_POST["po27_slc"]):null);
...
$co28=(isset($_POST["co28_txt"])?trim($_POST["co28_txt"]):null);
$po28=(isset($_POST["po28_slc"])?trim($_POST["po28_slc"]):null);
...
$co29=(isset($_POST["co29_txt"])?trim($_POST["co29_txt"]):null);
$po29=(isset($_POST["po29_slc"])?trim($_POST["po29_slc"]):null);
...
$co210=(isset($_POST["co210_txt"])?trim($_POST["co210_txt"]):null);
$po210=(isset($_POST["po210_slc"])?trim($_POST["po210_slc"]):null);
...
$co211=(isset($_POST["co211_txt"])?trim($_POST["co211_txt"]):null);
$po211=(isset($_POST["po211_slc"])?trim($_POST["po211_slc"]):null);
...
$saltos = array();
if ($cod1)
	$saltos[1] = array ("cod_salto" => $cod1, "pos" => $pos1, "alt" => $alt1, "abi" => $abi1, "cod_salto2" => $co21, "pos2" => $po21); 
if ($cod2)
	$saltos[2] = array ("cod_salto" => $cod2, "pos" => $pos2, "alt" => $alt2, "abi" => $abi2, "cod_salto2" => $co22, "pos2" => $po22); 
if ($cod3)
	$saltos[3] = array ("cod_salto" => $cod3, "pos" => $pos3, "alt" => $alt3, "abi" => $abi3, "cod_salto2" => $co23, "pos2" => $po23); 
if ($cod4)
	$saltos[4] = array ("cod_salto" => $cod4, "pos" => $pos4, "alt" => $alt4, "abi" => $abi4, "cod_salto2" => $co24, "pos2" => $po24); 
if ($cod5)
	$saltos[5] = array ("cod_salto" => $cod5, "pos" => $pos5, "alt" => $alt5, "abi" => $abi5, "cod_salto2" => $co25, "pos2" => $po25); 
if ($cod6)
	$saltos[6] = array ("cod_salto" => $cod6, "pos" => $pos6, "alt" => $alt6, "abi" => $abi6, "cod_salto2" => $co26, "pos2" => $po26); 
if ($cod7)
	$saltos[7] = array ("cod_salto" => $cod7, "pos" => $pos7, "alt" => $alt7, "abi" => $abi7, "cod_salto2" => $co27, "pos2" => $po27); 
if ($cod8)
	$saltos[8] = array ("cod_salto" => $cod8, "pos" => $pos8, "alt" => $alt8, "abi" => $abi8, "cod_salto2" => $co28, "pos2" => $po28);
if ($cod9)
	$saltos[9] = array ("cod_salto" => $cod9, "pos" => $pos9, "alt" => $alt9, "abi" => $abi9, "cod_salto2" => $co29, "pos2" => $po29);
if ($cod10)
	$saltos[10] = array ("cod_salto" => $cod10, "pos" => $pos10, "alt" => $alt10, "abi" => $abi10, "cod_salto2" => $co210, "pos2" => $po210);
if ($cod11)
	$saltos[11] = array ("cod_salto" => $cod11, "pos" => $pos11, "alt" => $alt11, "abi" => $abi11, "cod_salto2" => $co211, "pos2" => $po211);
...
if (is_null($mensaje)){
	$mensaje=valida_saltos_mix($modalidad,$categoria,$edad);
	$_SESSION["saltos"]= isset($saltos)?$saltos:null;
